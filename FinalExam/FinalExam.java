...
public class FinalExam {
    public static void main(String[] args) throws Exception {
        ...
        for (int row = 0; row < array.length; row++) {
            System.out.println("");
            for (int column = 0; column < array.length; column++) {
                if ((row == 13 && column == 12) || (row == 13 && column == 11) || (row == 13 && column == 10) || (row == 13 && column == 9) || (row == 13 && column == 8) || (row == 13 && column == 7) || (row == 13 && column == 6) || (row == 13 && column == 5) || (row == 13 && column == 4) || (row == 13 && column == 3) || (row == 13 && column == 2) ){
                    System.out.print(array[row][column]);
                }
                else {
                    System.out.print(".");
        ...
        for (int row = 0; row < array.length; row++) {
            System.out.println("");
            for (int column = 0; column < array.length; column++) {
                if ((row == 12 && column == 5) || (row == 11 && column == 4) || (row == 10 && column == 3) || (row == 9 && column == 2) || (row == 8 && column == 1) || (row == 7 && column == 0)){
                    System.out.print(array[row][column]);
                }
                else {
                    System.out.print(".");
